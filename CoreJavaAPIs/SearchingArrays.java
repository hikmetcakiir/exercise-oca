...
public class SearchingArrays {
	...
	public static void main(String... args) {
		...
		System.out.println(Arrays.binarySearch(notSortedNumbers, 4));
		System.out.println(Arrays.binarySearch(notSortedNumbers, 2));
		System.out.println(Arrays.binarySearch(notSortedNumbers, 3));

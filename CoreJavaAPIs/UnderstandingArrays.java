...
public class UnderstandingArrays {
	...
	public static void main(String... args) {
		...
		int ids2[], types2; // creates 1 array and int, bad practice
		...
		System.out.println(Arrays.equals(i, cd));
	}
